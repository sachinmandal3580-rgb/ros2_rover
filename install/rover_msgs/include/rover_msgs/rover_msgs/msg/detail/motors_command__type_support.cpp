...
void fetch_function__MotorsCommand__drive_motor(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__MotorsCommand__drive_motor(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__MotorsCommand__drive_motor(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__MotorsCommand__drive_motor(untyped_member, index));
...
void fetch_function__MotorsCommand__corner_motor(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__MotorsCommand__corner_motor(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__MotorsCommand__corner_motor(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__MotorsCommand__corner_motor(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorsCommand_message_member_array[2] = {
  {
    ...
    fetch_function__MotorsCommand__drive_motor,  // fetch(index, &value) function pointer
    assign_function__MotorsCommand__drive_motor,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__MotorsCommand__corner_motor,  // fetch(index, &value) function pointer
    assign_function__MotorsCommand__corner_motor,  // assign(index, value) function pointer
