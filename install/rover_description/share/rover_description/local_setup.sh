...
: ${AMENT_CURRENT_PREFIX:="/home/sachin/ros2_rover/install/rover_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_description/environment/gz_sim_resource_path.sh"
